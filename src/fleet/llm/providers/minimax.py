"""MiniMax adapter — direct MiniMax API.

MiniMax exposes an OpenAI-compatible /chat/completions endpoint at
api.minimax.io for the M-series models (MiniMax-M2, etc.). We reuse the
openai_compat client.

Docs: https://www.minimaxi.com/en/document/ChatCompletion
"""
